...
public class Staffinfo {
	...
	public static void main(String[] args) {
		...
		Staff yamada = new Staff("Taro Yamada",1234,"yamada@abc.co.jp");
		RemoteStaff tanaka = new RemoteStaff("Hinako tanaka",12456,"tanaka@abc.co.jp");
		tanaka.location = "大阪";
		
		//yamada.sayhello();
		System.out.println("【社員情報】");
		System.out.println("氏名：" + yamada.getName());
		System.out.println("社員ID：" + yamada.getStaffid());
		System.out.println("Email：" + yamada.getEmail());
		
		System.out.println("【社員情報】");
		System.out.println("氏名：" + tanaka.getName());
		System.out.println("社員ID：" + tanaka.getStaffid());
